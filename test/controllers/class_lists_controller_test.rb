...
class ClassListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create class_list" do
    assert_difference("ClassList.count") do
      post class_lists_url, params: { class_list: { section_id: @class_list.section_id, student_id: @class_list.student_id } }
    end
  ...
  test "should update class_list" do
    patch class_list_url(@class_list), params: { class_list: { section_id: @class_list.section_id, student_id: @class_list.student_id } }
